        ...
        <div class="swiper-wrapper wrapper">
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    ...
                    <a href="shoppages.php?searchbar=wedding" class="btn">VIEW</a>
                </div>
                <div class="image">
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit natus dolor cumque?</p>
                    <a href="shoppages.php?searchbar=portrait" class="btn">VIEW</a>
                </div>
                <div class="image">
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    ...
                    <h3>Event Shoot</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit natus dolor cumque?</p>
                    <a href="shoppages.php?searchbar=event" class="btn">VIEW </a>
                </div>
                <div class="image">
...
<section class="dishes" id="dishes">
    ...
    <?php
        ...
        select id,shop_name,shop_logo from photoshop.shop_master where shop_status=1;");
        $i=1;
...
<?php
        ...
        $result=mysqli_query($con,"
        select id,shop_name,shop_address,shop_logo from photoshop.shop_master where shop_status=1 LIMIT 8 ;
        ");
