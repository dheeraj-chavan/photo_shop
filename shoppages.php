...
<?php
        ...
        {
        $result=mysqli_query($con,"select id,shop_name,shop_address,shop_logo,shop_open,shop_close from photoshop.shop_master where shop_status=1 and shop_name like '%".$_GET["searchbar"]."%'
        or shop_spec like '%".$_GET["searchbar"]."%' ;");

        }
        else
        {
        $result=mysqli_query($con,"select id,shop_name,shop_address,shop_logo,shop_open,shop_close from photoshop.shop_master where shop_status=1;");
        }
