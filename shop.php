        ...
        <header class = "header" style="    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(images/header.jpg) center/cover no-repeat;">
            ...
            <div class = "container about">
                <div class = "about-content">
                    ...
                    <h2><?php  echo strtoupper($data[2]);?></h2>
                    <h3><?php 
                        if($data[12]==1)
                        {
                            echo "Indoor shoots || ";
                    ...
                    <blockquote>
                      <?php echo "|| ".strtoupper($data[14])." &nbsp; ".strtoupper($data[15])." &nbsp;  ".strtoupper($data[16])." &nbsp; ".strtoupper($data[17])." &nbsp; ".strtoupper($data[18])."&nbsp;".strtoupper($data[19])." ||";
